...
- **[opencode-handoff](./opencode-handoff/SKILL.md)** — Hand the current conversation off to a fresh opencode session seeded with a handoff summary via `opencode run --title "<name>" "<summary>"`. User-invoked.
