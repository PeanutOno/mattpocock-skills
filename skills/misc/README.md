...
- **[git-guardrails](./git-guardrails/SKILL.md)** — Set up an opencode plugin to block dangerous git commands (push, reset --hard, clean, etc.) before the agent executes them.
